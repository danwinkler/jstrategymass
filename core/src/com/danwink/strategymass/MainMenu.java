...
import com.danwink.strategymass.screens.play.TrainScreen;
...
public class MainMenu extends MenuScreen {
	...
	public void render(float dt) {
		if (Gdx.input.isKeyPressed(Keys.T) && Gdx.input.isKeyPressed(Keys.CONTROL_LEFT)) {
			StrategyMass.game.setScreen(new TrainScreen());
		}
		super.render(dt);
	}
}
